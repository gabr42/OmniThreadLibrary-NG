unit bench_32_mobile_main;

// FMX variant of the TOmniBaseQueue benchmark. Auto-runs on form
...
var
  frmBench32Mobile: TfrmBench32Mobile;
...
procedure TfrmBench32Mobile.AppendLine(const msg: string);
begin
...
procedure TfrmBench32Mobile.SetStatus(const s: string);
begin
  lblStatus.Text := s;
end;

procedure TfrmBench32Mobile.RunBenchOnWorker;
begin
      ...
      try
        ...
        TThread.Synchronize(nil,
          ...
          begin
            ...
            AppendLine('OTL_DIAG: bench32 done');
          end);
      except
...
procedure TfrmBench32Mobile.FormShow(Sender: TObject);
begin
