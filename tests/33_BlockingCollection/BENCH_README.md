...
"C:\Program Files (x86)\Embarcadero\Studio\37.0\bin\dcclinux64.exe" \
  bench_33_console.dpr -B "-U../..;../../FastMM4" "-NSSystem;Data;Xml" \
...
cp ./Linux64/Debug/bench_33_console /c/Temp/bench_33_console
MSYS_NO_PATHCONV=1 WSLENV= wsl -- /mnt/c/Temp/bench_33_console
```

An earlier WSL manual-link harness (`C:\tmp_otl_link\linkit_bench_33.sh`
+ `make_bench_33_lnk_win.py` + `translate_lnk.py`) was retired
2026-04-26 — it had a TLS-layout bug that caused 4 GiB-per-thread
mmaps and OOM-killed the bench partway through 3→3.
